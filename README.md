...
| Folder | Description |
|------|-------------|
| `monetary_data_extraction_from_Arabic_historical_texts/` | Pipeline for extracting structured monetary information from Arabic historical texts using large language models and JSON schema validation |



Each section contains its own scripts, dependencies, and citation metadata.

---

## Citation

If you use this repository, please cite the software archive and/or the dissertation.
